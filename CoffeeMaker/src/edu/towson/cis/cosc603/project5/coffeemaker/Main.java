...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit"+septor);
	...
	public static void addRecipe() {
	    //Read in recipe name
		final String name = inputOutput(septor+"Please enter the recipe name: ");
	    
	    //Read in recipe price
	    final String priceString = inputOutput(septor+"Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput(septor+"Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(septor+"Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(septor+"Please enter the units of sugar in the recipe: ");
	    ...
	    final String chocolateString = inputOutput(septor+"Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
    	final  String coffeeString = inputOutput(septor+"Please enter the units of coffee to add: ");
    	final int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(septor+"Please enter the units of milk to add: ");
	    final int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(septor+"Please enter the units of sugar to add: ");
	    final int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt chocolate
	    final String chocolateString = inputOutput(septor+"Please enter the units of chocolate to add: ");
	    final int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
	    	mainMenu();
	    }
    ...
    public static void makeCoffee() {
        ...
        System.out.println("Your change is: " + change + septor);
        mainMenu();
    }
    ...
    static int stringToInt(String value) {
        ...
        try {
            ...
            System.out.println("Please input an integer"+septor);
        }
        return returnInt;
    }
    ...
    public static void main(String[] args) {
	    ...
	    System.out.println("Welcome to the CoffeeMaker!"+septor);
	    mainMenu();
	}
}
